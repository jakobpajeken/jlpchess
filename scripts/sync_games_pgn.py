...
def extract_annotations(game, old_annotations=None):
    ...
    intro_arrows, intro_highlights = extract_arrows_and_highlights(game.comment)
    ...
    if intro.get("de") or intro.get("en") or root_variations or intro_arrows or intro_highlights:
        ...
        if intro_arrows:
            root_entry["arrows"] = intro_arrows
        if intro_highlights:
            root_entry["highlights"] = intro_highlights
        line = [root_entry] + line
    return line
